...
- When shown a list of outstanding/roadmap items, wants the agent to just work through and complete all of them in order rather than pausing to ask which one to start with. Confidence: 0.5
